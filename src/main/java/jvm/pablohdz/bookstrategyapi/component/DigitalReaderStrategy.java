...
@Component
public class DigitalReaderStrategy implements ReaderStrategy {
  private final double COST_TYPE = 1.3;

  private final BookRepository bookRepository;

  @Autowired
  public DigitalReaderStrategy(BookRepository bookRepository) {
